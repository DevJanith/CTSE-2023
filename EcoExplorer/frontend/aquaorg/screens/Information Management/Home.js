        ...
        <ScrollView>
          <View style={{ flexDirection: "row" }}>
            <View style={{ flex: 2 }}>
              ...
              >
                Hi 😊 {typeof user != "undefined" && user.name}!{" "}
              </Text>
            </View>
          ...
          >
            <View>
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.push("InfoCategories");
                }}
                style={{
                  flexDirection: "row",
          ...
          >
            <View>
              ...
              >
                You can share your knlowledge by sharing with others......
                {"\n"}
                {"\n"}
